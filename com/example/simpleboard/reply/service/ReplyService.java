...
public class ReplyService extends CRUDAbstractApiController<ReplyDto, ReplyEntity> {
   ...
   /* private final ReplyRepository replyRepository;
    ...
    public ReplyEntity create(
        ...
        var optionnalPostEntity = postRepository.findById(replyRequest.getPostId());

        if(optionnalPostEntity.isEmpty()){
            throw new RuntimeException(("게시물이 존재 하지 않습니다 : " + replyRequest.getPostId()));
        }

        var entity = ReplyEntity.builder()
                .post(optionnalPostEntity.get())
